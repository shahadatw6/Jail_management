...
public class VisitorManagementOfficerDashboardController implements Initializable {
    ...
    private void reportButtonOnclick(ActionEvent event) throws IOException {
        Parent parent = FXMLLoader.load(getClass().getResource("/chartpractice/pieChart.fxml"));
        visitorManagementDashBoardBorderPane.setCenter(parent);
    }

    @FXML
    private void viewReportReqbuttonOnclick(ActionEvent event) throws IOException {
        
        Parent parent = FXMLLoader.load(getClass().getResource("/chartpractice/BarChart.fxml"));
        visitorManagementDashBoardBorderPane.setCenter(parent);
    }
